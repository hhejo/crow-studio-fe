...
const SidebarIconsContainer = (props) => {
  ...
  const { clickIcon, showingContent, goCodeShare } = props;
  const activeIconDir = showingContent === "Dir" ? " activeIcon" : "";
  const activeIconGit = showingContent === "Git" ? " activeIcon" : "";
  const activeIconTeam = showingContent === "Team" ? " activeIcon" : "";
  const activeIconApi = showingContent === "Api" ? " activeIcon" : "";
  const activeIconVar = showingContent === "Var" ? " activeIcon" : "";
  const activeIconSet = showingContent === "Set" ? " activeIcon" : "";
  ...
  const clickIconHandler = (clickedIconName) => {
    ...
    if (clickedIconName === "Dir")
      active || showingContent === "Dir" ? clickIcon("") : clickIcon("Dir");
    else if (clickedIconName === "Git")
      active || showingContent === "Git" ? clickIcon("") : clickIcon("Git");
    else if (clickedIconName === "Team")
      active || showingContent === "Team" ? clickIcon("") : clickIcon("Team");
    else if (clickedIconName === "Api")
      active || showingContent === "Api" ? clickIcon("") : clickIcon("Api");
    else if (clickedIconName === "Var")
      active || showingContent === "Var" ? clickIcon("") : clickIcon("Var");
    else if (clickedIconName === "Set")
      active || showingContent === "Set" ? clickIcon("") : clickIcon("Set");
    else if (clickedIconName === "Share")
      active || showingContent === "Share" ? clickIcon("") : clickIcon("Share");
  };
